<?php namespace App\Http\Controllers;
	...
	class AdminCustomersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Apellido paterno","name"=>"last_name"];
			$this->col[] = ["label"=>"Apellido materno","name"=>"second_last_name"];
			$this->col[] = ["label"=>"Tipo de documento","name"=>"document_type"];
			$this->col[] = ["label"=>"N° de documento","name"=>"document_number"];
			$this->col[] = ["label"=>"RUC","name"=>"ruc"];
			$this->col[] = ["label"=>"Razón social","name"=>"business_name"];
			$this->col[] = ["label"=>"Tipo de persona","name"=>"person"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nombres','name'=>'name','type'=>'text','validation'=>'required|string|min:3|max:50','width'=>'col-sm-10','placeholder'=>'Ingrese el nombre del cliente'];
			$this->form[] = ['label'=>'Apellido paterno','name'=>'last_name','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-10','placeholder'=>'Ingrese el apellido paterno del cliente'];
			$this->form[] = ['label'=>'Apellido materno','name'=>'second_last_name','type'=>'text','validation'=>'min:1|max:50','width'=>'col-sm-10','placeholder'=>'Ingrese el apellido materno del cliente'];
			...
			$this->form[] = ['label'=>'Correo electrónico','name'=>'email','type'=>'email','validation'=>'min:1|max:50|email|unique:customers','width'=>'col-sm-10','placeholder'=>'Introduzca una dirección de correo electrónico válida'];
			$this->form[] = ['label'=>'Estado','name'=>'state','type'=>'radio','validation'=>'required','width'=>'col-sm-10','dataenum'=>'1|Activo; 0|Inactivo'];
			...
			//$this->form[] = ['label'=>'Teléfono','name'=>'phone_number','type'=>'text','validation'=>'required|min:6|max:9','width'=>'col-sm-10','placeholder'=>'Ingrese un teléfono de contacto'];
			//$this->form[] = ['label'=>'Correo electrónico','name'=>'email','type'=>'email','validation'=>'min:1|max:50|email|unique:customers','width'=>'col-sm-10','placeholder'=>'Introduzca una dirección de correo electrónico válida'];
			//$this->form[] = ['label'=>'Estado','name'=>'state','type'=>'radio','validation'=>'required','width'=>'col-sm-10','dataenum'=>'Activo; Inactivo'];
			# OLD END FORM
